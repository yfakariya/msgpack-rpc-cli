...
{
	/// <summary>
	///		Defines common features for attribute parsing state.
	/// </summary>
	internal abstract class ServiceHostDirectiveParsingState : SvcDirectiveParserState
	{
		/// <summary>
		///		Buffer to store parsing string.
		/// </summary>
