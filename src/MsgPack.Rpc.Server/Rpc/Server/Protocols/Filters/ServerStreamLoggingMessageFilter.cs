...
{
	/// <summary>
	///		<see cref="StreamLoggingMessageFilter{T}"/> for <see cref="ServerRequestContext" />.
	/// </summary>
	public sealed class ServerStreamLoggingMessageFilter : StreamLoggingMessageFilter<ServerRequestContext>
	{
		/// <summary>
