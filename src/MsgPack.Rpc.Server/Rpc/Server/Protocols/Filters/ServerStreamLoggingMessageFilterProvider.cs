...
{
	/// <summary>
	///		<see cref="StreamLoggingMessageFilterProvider{T}"/> for <see cref="ServerRequestContext"/>.
	/// </summary>
	public sealed class ServerStreamLoggingMessageFilterProvider : StreamLoggingMessageFilterProvider<ServerRequestContext>
	{
		private readonly ServerStreamLoggingMessageFilter _filterInstance;
